...
public enum SoccerAggregationData implements AggregationData
{
    ...
    RED_CARDS
    {
        ...
        {
            return  "LEFT JOIN( " +
                    "   SELECT SOCCER02.MATCHRELDIMMART.TEAM_AWAYTEAM_ID AS ATID, SOCCER02.MATCHRELDIMMART.MATCH_ID AS AMID, SOCCER02.MATCHRELDIMMART.AWAYREDCNT + SOCCER02.MATCHRELDIMMART.AWAYRED2CNT AS AWAY " +
                    "   FROM SOCCER02.MATCHRELDIMMART " +
                    ") " +
                    "ON (SOCCER02.MATCH.MATCH_ID=AMID AND SOCCER02.TEAM.TEAM_ID=ATID) " +
                    "LEFT JOIN( " +
                    "   SELECT SOCCER02.MATCHRELDIMMART.TEAM_HOMETEAM_ID AS HTID, SOCCER02.MATCHRELDIMMART.MATCH_ID AS HMID, SOCCER02.MATCHRELDIMMART.HOMEREDCNT + SOCCER02.MATCHRELDIMMART.HOMERED2CNT AS HOME " +
                    "   FROM SOCCER02.MATCHRELDIMMART " +
                    ") " +
                    "ON (SOCCER02.MATCH.MATCH_ID=HMID AND SOCCER02.TEAM.TEAM_ID=HTID)";
