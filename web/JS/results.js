function showData() {
        ...
        */
        ...
        var teams = getRestResource("HomeAndAwayTeamListResource", token["token"]);
        var ballPossession = getRestResource("BallPossessionResource", token["token"]);
        var yellowCards = getRestResource("YellowCardStatResource", token["token"]);
        var cornerStats = getRestResoruce("CornerStatsResource", token["token"]);
        var redCards = getRestResource("RedCardsStatResource", token["token"]);
        var foulStats = getRestResource("FoulsStatResource", token["token"]);
